            ...
            <div class="collapse navbar-collapse" id="navbarTogglerDemo03">
                <ul class="navbar-nav ms-auto mb-2 mb-lg-0">
                    ...
                    <li class="nav-item">
                        ...
                        <?php else: ?>
                        <a class="btn login-btn" href="<?php echo e(route('login')); ?>">Log in</a>
                        <?php if(Route::has('register')): ?>
                        <a class="btn register-btn" href="<?php echo e(route('register')); ?>">Register</a>
                        <?php endif; ?>
                        <?php endif; ?>
                    </li>
                    <?php endif; ?>
...
<?php /**PATH C:\Users\Faathir.A.N\OneDrive\Documents\Kuliah Moment\SEMESTER 5\PBW\Tugas-Besar\capsswing\resources\views/welcome.blade.php ENDPATH**/ ?>