                    ...
                    <table class="min-w-full border-collapse border border-gray-200 bg-gray-50 shadow-md rounded-lg">
                        <thead>
                            <tr class="bg-indigo-500 text-white">
                                ...
                                <th class="border border-gray-200 px-6 py-3 text-left font-semibold">Keberangkatan</th>
                                <th class="border border-gray-200 px-6 py-3 text-left font-semibold">Tiba</th>
                        ...
                        <tbody>
                            ...
                            <tr class="hover:bg-gray-100 transition ease-in-out duration-150">
                                ...
                                <td class="border border-gray-200 px-6 py-3">{{ $product->departure_time }}</td>
                                <td class="border border-gray-200 px-6 py-3">{{ $product->arrival_time }}</td>
                                <td class="border border-gray-200 px-6 py-3">Rp{{ number_format($product->price) }}</td>
