<x-app-layout>
    ...
    <div class="py-6 px-4 sm:px-6 lg:px-64">
        <div class="max-w-10xl mx-auto sm:px-4 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg px-4 py-8">
    
                <!-- Form Pencarian -->
                <div class="mb-6 max-w-7xl mx-auto sm:px-6 lg:px-8 flex flex-wrap gap-4">
    
                    <form method="GET" action="{{ route('tickets') }}" class="grid grid-cols-1 gap-4 md:grid-cols-3 w-full">
                        @csrf
                ...
                <!-- Daftar Tiket -->
                @if ($products->isEmpty())
                <p class="text-gray-500 text-center">Tidak ada tiket yang ditemukan untuk pencarian Anda.</p>
                @else
                <div class="max-w-7xl mx-auto">
                    <h2 class="text-lg font-semibold text-gray-800 mb-4">Daftar Tiket</h2>
                    <table class="w-full border-collapse border border-gray-200 bg-gray-50 shadow-lg rounded-lg">
                        <tbody>
