                                    ...
                                    <div class="flex items-center justify-between">
                                        ...
                                        <div class="flex items-center space-x-8">
                                            ...
                                            <div class="text-center">
                                                <p class="font-semibold text-sm text-gray-700">{{ $product->departure_time }}</p>
                                            ...
                                            <!-- Kedatangan -->
                                            <div class="text-center">
                                                <p class="font-semibold text-sm text-gray-700">{{ $product->arrival_time }}</p>
                                                <p class="text-gray-500 text-xs">{{ $product->arrival_location }}</p>
                                            </div>
                                        </div>
                                        <!-- Harga -->
                                        <div class="text-right">
                                            <p class="text-red-500 font-bold text-lg">Rp{{ number_format($product->price) }}</p>
                                        </div>
                                    </div>
                                </td>
                            </tr>
