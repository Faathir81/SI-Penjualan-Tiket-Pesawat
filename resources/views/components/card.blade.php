    ...
    <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
      ...
      <div class="max-w-sm rounded-lg overflow-hidden shadow-lg border border-gray-200">
        ...
        <div class="p-4">
          ...
          <div class="mt-4">
            ...
            <p class="text-xl font-bold text-red-600">IDR 74.580.000</p>
          </div>
        </div>
      </div>
      ...
      <div class="max-w-sm rounded-lg overflow-hidden shadow-lg border border-gray-200">
        ...
        <div class="p-4">
          ...
          <div class="mt-4">
            <p class="text-sm text-gray-500">Mulai dari</p>
            <p class="text-xl font-bold text-red-600">IDR 54.420.000</p>
          </div>
        </div>
      </div>
      ...
      <div class="max-w-sm rounded-lg overflow-hidden shadow-lg border border-gray-200">
        ...
        <div class="p-4">
          ...
          <div class="mt-4">
            <p class="text-sm text-gray-500">Mulai dari</p>
            <p class="text-xl font-bold text-red-600">IDR 17.560.000</p>
          </div>
        </div>
      </div>
    </div>
